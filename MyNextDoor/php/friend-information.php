...
// get the friend-list
    ...
    if ($stmt = $mysqli->prepare("SELECT uname, address, profile, email FROM user WHERE uid = ?;")) {
        $stmt->bind_param("i", $search_id);
        $stmt->execute();
        $stmt->bind_result($personal_name, $personal_address, $personal_profile, $personal_email);
        $stmt->store_result();
...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="../js/friend-information.js"></script>
	</head>
				...
				<div class="row col-sm-offset-1 col-sm-8 well">
					<div class="panel panel-success">
						...
						<div class="col-sm-offset-2 panel-body">
							...
							<button type="button" class="friend-apply btn btn-success">return</button>
						</div>
					</div>
